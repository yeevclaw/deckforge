...
<!-- Golden fixture for the change-time verification loop
     (.claude/skills/deckforge-verify). Frozen input: edits to this file and
     evals/planning.json happen only together, in their own commit, re-baselined
     by one content-grader (07) pass. Guarded by scripts/check_docs.py check 8. -->
