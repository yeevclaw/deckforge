...
> **注意**:下方 gate 1/2 是 v0.9.0 當時的措辭。v0.12.0 已放寬:**真循環**(true cycle,
> 旋轉本身即訊息)也符合 gate 1;gate 2 的範圍是 money slide **或全篇核心流程/循環圖**。
> 現行決策流以 `prompts/04_planning_draft.md` → "Motion pages" 為準。
