...
- **`references/rubric.md`**: grade against the "Phase 5 — VISUAL" section, ids
  **P5-01 through P5-08**. (P5-09 is speaker notes — **not** a visual check; skip it,
  the caller verifies notes against metadata at delivery.)
...
1. Look at the actual pixels. Do not read or critique the SVG source — you are grading
   ...
   after rasterization.
2. Test it against P5-01..P5-08. For every criterion it fails, record one `failure`:
...
- Every `failure` carries exactly one `rubric_id` from P5-01..P5-08.
