...
- **Labels**: `#A0A0A0` 12–14px. Axis labels in English, data labels in CN. (Reading-mode pages floor every chart label at **16px** — if floored labels collide, reduce categories or switch to `chart_hbar`; see `references/slidedoc.md`.)
